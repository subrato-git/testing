...
<body bgcolor="teal">
	<div id="main">
		...
		<fieldset id="button_container">
			<button> <a href="question_main.php" style="text-decoration:none">Upload Question</a></button><br><br>
			<button><a href="customized_search.php" style="text-decoration:none">Customized Search</a></button><br><br>
			<button>Help</button>
		</fieldset>
